...
REQUIRED_FILES = [
    ...
    "api/factory_signal_board/role_workflow_models.py",
    "api/factory_signal_board/role_workflow_repository.py",
    "api/factory_signal_board/role_workflow_service.py",
    "api/factory_signal_board/ontology_planner_models.py",
    "api/factory_signal_board/ontology_planner_service.py",
    "api/factory_signal_board/security.py",
    "api/factory_signal_board/export_models.py",
    "api/factory_signal_board/export_repository.py",
    "api/factory_signal_board/export_service.py",
