...
OBJECT_TYPES: tuple[ObjectTypeDefinition, ...] = (
    ...
    ObjectTypeDefinition(
        id="component",
        display_name="Equipment Component",
        description="설비 점검 위치와 SOP를 연결하는 versioned 부품/계통 reference 객체입니다.",
        domain_pack="manufacturing-predictive-maintenance",
        interfaces=["maintainable", "inspection-reference", "versioned"],
        properties=[
            OntologyProperty(id="asset_id", display_name="설비 ID", value_type="string", required=True),
            OntologyProperty(id="component_id", display_name="부품 ID", value_type="string", required=True),
            OntologyProperty(id="component_label", display_name="부품명", value_type="string", required=True),
            OntologyProperty(id="location_label", display_name="점검 위치", value_type="string"),
            OntologyProperty(id="inspection_method", display_name="점검 방법", value_type="string"),
            OntologyProperty(id="dataset_version_id", display_name="Dataset Version", value_type="string", required=True),
        ],
    ),
    ObjectTypeDefinition(
        id="sop",
        display_name="Inspection SOP",
        description="사람 승인 하에 사용하는 점검 절차 reference입니다. 실행 권한 자체를 의미하지 않습니다.",
        domain_pack="manufacturing-predictive-maintenance",
        interfaces=["document", "inspection-reference", "versioned"],
        properties=[
            OntologyProperty(id="sop_id", display_name="SOP ID", value_type="string", required=True),
            OntologyProperty(id="title", display_name="절차명", value_type="string", required=True),
            OntologyProperty(id="version", display_name="버전", value_type="string"),
            OntologyProperty(id="requires_human_approval", display_name="사람 승인 필요", value_type="boolean"),
            OntologyProperty(id="dataset_version_id", display_name="Dataset Version", value_type="string", required=True),
        ],
    ),
    ObjectTypeDefinition(
    ...
    ObjectTypeDefinition(
        id="maintenance_case",
        display_name="Maintenance Case",
        description="하나의 위험 Event에서 이어진 점검·정비 closed-loop 기록을 묶는 감사 가능한 Case 객체입니다.",
        domain_pack="manufacturing-predictive-maintenance",
        interfaces=["history", "maintainable", "auditable", "versioned"],
        properties=[
            OntologyProperty(id="event_id", display_name="위험 Event ID", value_type="string", required=True),
            OntologyProperty(id="asset_id", display_name="설비 ID", value_type="string", required=True),
            OntologyProperty(id="status", display_name="Case 상태", value_type="string", required=True),
            OntologyProperty(id="work_order_count", display_name="작업요청 수", value_type="integer"),
            OntologyProperty(id="maintenance_action_count", display_name="정비 작업 수", value_type="integer"),
            OntologyProperty(id="outcomes", display_name="결과", value_type="array"),
            OntologyProperty(id="dataset_version_id", display_name="Dataset Version", value_type="string", required=True),
        ],
    ),
    ObjectTypeDefinition(
...
LINK_TYPES: tuple[LinkTypeDefinition, ...] = (
    ...
    LinkTypeDefinition(
        id="equipment_has_component",
        display_name="Equipment has Component",
    ...
    LinkTypeDefinition(
        id="component_inspected_by_sop",
        display_name="Component inspected by SOP",
    ...
    LinkTypeDefinition(
        id="equipment_has_maintenance_case",
        display_name="Equipment has Maintenance Case",
        source_type="equipment",
        target_type="maintenance_case",
        cardinality="one-to-many",
        domain_pack="manufacturing-predictive-maintenance",
    ),
    LinkTypeDefinition(
        id="risk_event_led_to_maintenance_case",
        display_name="Risk Event led to Maintenance Case",
        source_type="risk_event",
        target_type="maintenance_case",
    ...
    LinkTypeDefinition(
        id="maintenance_case_has_work_order",
        display_name="Maintenance Case has Work Order",
    ...
    LinkTypeDefinition(
        id="maintenance_case_has_maintenance_action",
        display_name="Maintenance Case has Maintenance Action",
        source_type="maintenance_case",
        target_type="maintenance_action",
        cardinality="one-to-many",
        domain_pack="manufacturing-predictive-maintenance",
    ...
    LinkTypeDefinition(
        id="maintenance_case_similar_to",
        display_name="Maintenance Case similar to Maintenance Case",
        source_type="maintenance_case",
        target_type="maintenance_case",
        cardinality="many-to-many",
        domain_pack="manufacturing-predictive-maintenance",
    ...
    LinkTypeDefinition(
        id="production_cycle_produces_product",
        display_name="Production Cycle produces Product",
        source_type="production_cycle",
        target_type="product",
        cardinality="many-to-one",
        domain_pack="manufacturing-predictive-maintenance",
    ),
    LinkTypeDefinition(
        id="equipment_produces_product",
        display_name="Equipment currently produces Product",
        source_type="equipment",
        target_type="product",
        cardinality="many-to-many",
        domain_pack="manufacturing-predictive-maintenance",
