...
PERMISSION_DEFINITIONS: dict[str, str] = {
    ...
    "knowledge.read": "Project 범위 내 승인된 Enterprise Knowledge 검색",
    "knowledge.ingest": "Project Enterprise Knowledge 문서와 새 버전 적재",
    "knowledge.index": "Project Enterprise Knowledge hybrid index 재구축",
