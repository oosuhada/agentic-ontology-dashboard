...
2026-08-03 현재 Phase 3 Physical Namespace Relocation 전체가 완료됐다. `api/factory_signal_board/`, setuptools legacy package discovery, `ontology_dashboard.__path__` extension은 제거됐으며 다음 세션은 이 Phase를 반복하지 않는다.
