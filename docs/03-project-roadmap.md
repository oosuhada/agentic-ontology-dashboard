...
- Analysis, Export/Workflow, and remaining Ontology physical relocation before deleting the namespace path extension; foundation/identity and Dashboard are complete
...
- Analysis compatibility slice: `NEXT`
- Export/Workflow, remaining Ontology, shim cleanup, path-extension removal: `PENDING`
