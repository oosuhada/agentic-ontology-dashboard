...
export const RELIABILITY_SURFACES: Record<ReliabilityExperienceKind, ReliabilitySurface[]> = {
  executive: [
    { id: "executive-brief", view: "reports", label: copy("Executive Brief", "Executive Brief"), detail: copy("가치 실현 · KPI · 보고", "Value realization · KPI · reporting"), page: page("경영 브리핑", "운영 대응이 만든 가치와 KPI 영향", "위험을 얼마나 빨리 발견했는지가 아니라, 선제 대응으로 어떤 생산·재무 가치를 보호하고 KPI에 기여했는지를 같은 Decision Case 근거로 설명합니다.", "EXECUTIVE BRIEF", "Business value and KPI impact of operational response", "Explain not only what risk was detected, but which production and financial value the response protected and how it contributes to KPIs, using the same Decision Case evidence." ) },
    ...
    { id: "maintenance-effect", view: "objects", label: copy("정비 효과", "Maintenance effect"), detail: copy("Before-after · 가치 실현", "Before-after · value realization"), page: page("정비 효과", "정비가 만든 운영 가치 검증", "정비 전후 위험·알림·센서 변화를 확인해 현장 작업이 생산 연속성 보호와 KPI 개선으로 이어졌는지 검증합니다. 실제 절감액은 재무 actual이 연결된 경우에만 확정합니다.", "MAINTENANCE EFFECT", "Verify operational value created by maintenance", "Use before/after risk, alert, and sensor evidence to verify whether field work protected production continuity and improved KPIs. Realized savings require linked financial actuals." ) },
  ],
  operations: [
    ...
    { id: "production-impact", view: "objects", label: copy("생산 · 가치 영향", "Production & value impact"), detail: copy("보호 수량 · 비용 노출 · 제품", "Protected units · exposure · product"), page: page("생산 · 가치 영향", "선제 대응이 보호하는 생산·재무 가치", "예상 정지와 계획 손실 수량을 제품 경제성과 연결해 이 Case가 실제 손실로 확정되기 전에 보호하려는 가치 규모를 보여줍니다.", "PRODUCTION & VALUE IMPACT", "Production and financial value protected by early response", "Connect modeled downtime and planned unit loss to product economics to show the value this case is intended to protect before exposure becomes realized loss." ) },
...
const ROLE_DETAIL_SURFACES: Partial<Record<ReliabilityExperienceKind, ReliabilitySurface[]>> = {
  executive: [
    { id: "executive-kpi", view: "reports", label: copy("가치 · 운영 KPI", "Value & operating KPI"), detail: copy("Lead time · 보호 가치 · Backlog", "Lead time · value at risk · backlog"), page: page("가치 · 운영 KPI", "현장 대응을 회사 성과로 연결", "Decision Lead Time, Report Lead Time, backlog와 생산·재무 노출을 함께 보며 현장 대응이 생산 연속성과 경영 KPI에 어떤 기여를 만드는지 확인합니다.", "VALUE & OPERATING KPI", "Connect operational response to company performance", "Review decision lead time, report lead time, backlog, and production/financial exposure together to see how operational response contributes to continuity and business KPIs.") },
